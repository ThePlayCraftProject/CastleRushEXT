...
import marvel.android.castleattackers.game.try2.spells.SpellEffect;
	...
	private boolean castSpell() {
		...
		case lavaTroll:
			World.spells.add(new Spells(position.x + 40, position.y + 40, 35,
					35, this, target, Spells.Spell.fireBolt)); // ArrayList.add Method
														// returns true if an
														// object was added
			return true;
		case iceTroll:
			World.spells.add(new Spells(position.x + 40, position.y, 60, 40,
					this, target, Spells.Spell.grumblingIce));
			return false;
		default:
			return false;
		}
